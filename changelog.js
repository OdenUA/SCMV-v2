...
window.CHANGELOG = [
  {
    ...
    date: '2026-09-10',
    items: [
      'Добавлено модальное окно создания пары «устройство + ТС» (кнопка «Добавить ТС» в списке ТС): таблица с полями, вставка строк из Excel с автоопределением IMEI/телефона/ICCID/филиала, автоматическая привязка транспорта к устройству, проверка уникальности IMEI/ICCID/телефона (внутри таблицы и по существующей базе).'
    ]
  },
  {
    version: '1.0.6',
