...
/**
 * Dropdown for fleet selection.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun FleetFilterDropdown(
    fleets: List<Fleet>,
    selectedFleetId: Int?,
    onFleetSelected: (Int?) -> Unit
) {
    var expanded by remember { mutableStateOf(false) }
    val selectedFleet = fleets.find { it.id == selectedFleetId }
    val displayText = selectedFleet?.name ?: stringResource(R.string.device_all_fleets)
    ...
    Box(
        ...
        ExposedDropdownMenuBox(
            ...
            OutlinedTextField(
                ...
                onValueChange = {},
                readOnly = true,
                label = { Text(stringResource(R.string.fleet_filter)) },
                trailingIcon = {
            ...
            ExposedDropdownMenu(
                ...
                // "All" option
                DropdownMenuItem(
                    text = { Text(stringResource(R.string.device_all_fleets)) },
                    onClick = {
