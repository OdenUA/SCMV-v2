...
var bulkDeleteAnomaliesBtn = document.getElementById('bulkDeleteAnomaliesBtn');
var bulkDeleteModal = document.getElementById('bulkDeleteModal');
var bulkDeleteCloseBtn = document.getElementById('bulkDeleteCloseBtn');
var bulkDeleteForm = document.getElementById('bulkDeleteForm');
var bulkDeleteSpeedCheck = document.getElementById('bulkDeleteSpeedCheck');
var bulkDeleteSpeedValue = document.getElementById('bulkDeleteSpeedValue');
var bulkDeleteDistanceCheck = document.getElementById('bulkDeleteDistanceCheck');
var bulkDeleteDistanceValue = document.getElementById('bulkDeleteDistanceValue');
var bulkDeleteCancelBtn = document.getElementById('bulkDeleteCancelBtn');
var bulkDeleteOkBtn = document.getElementById('bulkDeleteOkBtn');
